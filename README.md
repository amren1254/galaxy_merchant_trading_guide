...
- Implemented a CLI app adhering SOLID design principles and OOPs Concept
- Packages :
  - utils/calculate.go  - contains methods to calculate prices for distinct resources
  - utils/convert.go    - contains methods to transform received input to roman and then calculate credit
  - utils/statement.go - handles input scenario for different input types
